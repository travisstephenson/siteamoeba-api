...
{`<script data-no-optimize="1" src="https://api.siteamoeba.com/api/widget/script/${createdCampaignId}"></script>`}
                  </pre>
                  <Button
                    size="icon"
                    variant="ghost"
                    ...
                    onClick={() => {
                      navigator.clipboard.writeText(`<script data-no-optimize="1" src="https://api.siteamoeba.com/api/widget/script/${createdCampaignId}"></script>`);
                      setPixelCopied(true);
