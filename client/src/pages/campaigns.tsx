...
{`<script>(function(){var s=document.createElement('script');s.src='https://api.siteamoeba.com/api/widget/script/${createdCampaignId}';s.async=true;document.head.appendChild(s);})();</script>`}
                  </pre>
                  <Button
                    size="icon"
                    variant="ghost"
                    ...
                    onClick={() => {
                      navigator.clipboard.writeText(`<script>(function(){var s=document.createElement('script');s.src='https://api.siteamoeba.com/api/widget/script/${createdCampaignId}';s.async=true;document.head.appendChild(s);})();</script>`);
                      setPixelCopied(true);
